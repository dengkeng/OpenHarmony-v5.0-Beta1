...
napi_value I18nSystemAddon::GetDisplayCountryImpl(napi_env env, napi_callback_info info, bool throwError)
{
    ...
    if (value.length() == 0) {
        napi_throw_type_error(env, nullptr, "getDisplayCountry: result is empty.");
    }
    napi_value result = nullptr;
    ...
    std::string index)
{
    ...
    if (status != napi_ok) {
        ...
        std::string message = "getDisplayCountry: Failed to get string item argv[" + index + "].";
...
napi_value I18nSystemAddon::GetDisplayLanguageImpl(napi_env env, napi_callback_info info, bool throwError)
{
    ...
    if (value.length() == 0) {
        std::string message = "getDisplayLanguage: result is empty.";
        napi_throw_type_error(env, nullptr, message.c_str());
        return nullptr;
    }
    napi_value result = nullptr;
    ...
    std::string index)
{
    ...
    if (status != napi_ok) {
        ...
        std::string message = "getDisplayLanguage: Failed to get string item argv[" + index + "].";
        napi_throw_type_error(env, nullptr, message.c_str());
        return false;
    }
    return true;
...
napi_value I18nSystemAddon::GetSystemCountriesImpl(napi_env env, napi_callback_info info, bool throwError)
{
    ...
    if (status != napi_ok) {
        std::string message = "getSystemCountries: Failed to get string item.";
        napi_throw_type_error(env, nullptr, message.c_str());
        return nullptr;
    }
...
napi_value I18nSystemAddon::IsSuggestedImpl(napi_env env, napi_callback_info info, bool throwError)
{
    ...
    if (status != napi_ok) {
        std::string message = "isSuggested: Failed to get string item argv[0]";
        napi_throw_type_error(env, nullptr, message.c_str());
        return nullptr;
    }
    ...
    if (VariableConvertor::CheckNapiValueType(env, argv[1])) {
        ...
        if (status != napi_ok) {
            std::string message = "isSuggested: Failed to get string item argv[1]";
            napi_throw_type_error(env, nullptr, message.c_str());
            return nullptr;
        }
...
napi_value I18nSystemAddon::SetSystemLanguageImpl(napi_env env, napi_callback_info info, bool throwError)
{
    ...
    if (status != napi_ok) {
        ...
        std::string message = "setSystemLanguage: Failed to get string item.";
        napi_throw_type_error(env, nullptr, message.c_str());
        return nullptr;
    }
...
napi_value I18nSystemAddon::SetSystemRegionImpl(napi_env env, napi_callback_info info, bool throwError)
{
    ...
    if (status != napi_ok) {
        ...
        std::string message = "setSystemRegion: Failed to get string item.";
        napi_throw_type_error(env, nullptr, message.c_str());
        return nullptr;
    }
...
napi_value I18nSystemAddon::SetSystemLocaleImpl(napi_env env, napi_callback_info info, bool throwError)
{
    ...
    if (status != napi_ok) {
        ...
        std::string message = "setSystemLocale: Failed to get string item.";
        napi_throw_type_error(env, nullptr, message.c_str());
        return nullptr;
    }
...
napi_value I18nSystemAddon::Set24HourClockImpl(napi_env env, napi_callback_info info, bool throwError)
{
    ...
    if (status != napi_ok) {
        ...
        std::string message = "set24HourClock: Failed to get boolean item.";
        napi_throw_type_error(env, nullptr, message.c_str());
        return nullptr;
    }
...
napi_value I18nSystemAddon::AddPreferredLanguageImpl(napi_env env, napi_callback_info info, bool throwError)
{
    ...
    if (VariableConvertor::CheckNapiValueType(env, argc > 1 ? argv[1] : nullptr)) {
        ...
        if (status != napi_ok) {
            ...
            std::string message = "addPreferrdLanguage: get index failed.";
            napi_throw_type_error(env, nullptr, message.c_str());
            return nullptr;
        }
    }
...
napi_value I18nSystemAddon::RemovePreferredLanguageImpl(napi_env env, napi_callback_info info, bool throwError)
{
    ...
    if (status != napi_ok) {
        ...
        std::string message = "removePreferrdLanguage: get index failed.";
        napi_throw_type_error(env, nullptr, message.c_str());
        return nullptr;
    }
...
bool I18nSystemAddon::ParseStringParam(napi_env env, napi_value argv, bool throwError, std::string &strParam)
{
    ...
    if (status != napi_ok) {
        ...
        std::string message = "get string parameter length failed.";
        napi_throw_type_error(env, nullptr, message.c_str());
        return false;
    }
